        ...
        <div className="combo-detail-wrap mt-12 grid gap-10 px-10 relative z-10 mobile-scroll">
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-4">
            ...
            <div className="combo-column sm:col-span-0 md:col-span-1">
              <h4 className="gilory-font-bold mb-5">
                Corporate & Outdoor Branding Concepts
              </h4>
              <ul className="deal-list gilory-font">
                <li>Storefront/Signboard Concept</li>
                <li>Vehicle Branding (Side + Rear)</li>
                <li>Directional / Office Branding Layout</li>
                <li>Event Backdrop / Standee</li>
              </ul>
            </div>
            ...
            <div className="combo-column sm:col-span-0 md:col-span-1">
              <h4 className="gilory-font-bold mb-5">
                5-Page Business Website (WordPress)
              </h4>
              <ul className="deal-list gilory-font">
                <li>Home</li>
                <li>About</li>
                ...
                <li>Contact with Map + WhatsApp Button</li>
                <li>Mobile Optimized</li>
                <li>Speed & Security Setup</li>
                <li>Admin Login + Training Guide</li>
                <li>Lead Form + Email Notification Setup</li>
            ...
            <div className="combo-column-lg sm:col-span-0 md:col-span-2 lg:col-span-2">
              <h4 className="gilory-font-bold mb-5">Christmas Grand Bonus</h4>
              <ul className="deal-list gilory-font combo-bonus">
                <li>15 Premium Mockups</li>
                <li>Mini Brand Book (Logo Rules, Colors, Fonts, Usage)</li>
                <li>1 Extra Social Media Banner</li>
                <li>Free Domain & Hosting Consultation</li>
              </ul>
            </div>
          </div>
        </div>
