        ...
        <div className="flex flex-col gap-4 items-center sm:justify-between sm:flex-row ">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div className="flex flex-col footer">
              {/* Logo container */}
              <div className="relative h-12 w-[250px] img">  {/* Bigger + proper size */}
                <Image
              ...
              <span className="subtitle-md py-6 z-99">
          ...
          <button
            ...
            className="inline-flex items-center gap-3 rounded-full border border-white/40
             ...
             transition-colors duration-200 gilory-font-semibold subtitle z-99"
          >
