  ...
  return (
    <>
      <section className="HolidayUpgrade relative bg-black">
        <div className="flex justify-center sm:block hidden">
          <div className="sm:pt-12">
            ...
            <p className="text-center gilory-font text-[20px]">
              From logos to full brand identity kits, choose the services your
              business needs. We give your brand a fresh, professional edge for
              2025.
            </p>
          </div>
        </div>
        ...
        {/* LEFT SNOW */}
        <div className="pointer-events-none select-none absolute top-20 -left-45 flex items-end">
          <div className="relative   w-[400px] sm:w-[400px] md:w-[400px] lg:w-[450px] aspect-[3/2] -translate-x-6 sm:-translate-x-10 sm:block hidden">
            <Image
        ...
        {/* Left Starts  */}
        <div className="pointer-events-none select-none absolute top-20 left-20 flex items-end">
          <div className="relative   w-[400px] sm:w-[400px] md:w-[400px] lg:w-[300px] aspect-[2/2] -translate-x-6 sm:-translate-x-10 sm:block hidden">
            <Image
        ...
        {/* Right Starts  */}
        <div className="pointer-events-none select-none absolute -top-10 -right-15 flex items-end">
          <div className="relative   w-[400px] sm:w-[400px] md:w-[400px] lg:w-[500px] aspect-[2/2] -translate-x-6 sm:-translate-x-10 sm:block hidden">
            <Image
        ...
        <div className="text-center christmas_deal_bg">
          ...
          <p className="subtitle-md !mb-18">
            Get a clean, high-impact brand ready for the new year.
          </p>
